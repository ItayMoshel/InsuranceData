...
# # })
# #
# # new_customer2 = pd.get_dummies(new_customer2, columns=cat_cols)
# # new_customer2 = new_customer2.reindex(columns=X_train.columns, fill_value=0)  # add missing columns with default values
# # prediction2 = model.predict(new_customer2)
# #
# # print('Predicted insurance cost: $', prediction2[0])
#
#
# import pandas as pd
# from sklearn.linear_model import LinearRegression
